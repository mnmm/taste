...
MetronicApp.factory('authorizationService', function ($resource, $q, $rootScope, $location) {
    return {
        ...
        permissionCheck: function (roleCollection) {
            ...
            if (this.permissionModel.isPermissionLoaded) {
                ...
                $resource(appPath+'/api/permissionService').get().$promise.then(function (response) {
